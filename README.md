...
Este repo es un recordatorio educativo: ejemplos pequeños, ejecutables y en Java puro.
...
## Cómo compilar cualquier ejemplo (copiar y pegar)
...
## Cómo generar Javadoc (copiar y pegar)
...
Cada ejemplo es autocontenido: todas las clases están en el mismo directorio
y sin packages, para que la compilación sea simple.

## Filosofia del repo
- Primero ves el "bad": muestra el problema de diseño.
...
- Lee el README del principio antes de leer el código.
